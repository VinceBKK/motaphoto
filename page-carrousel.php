      ...
      <div class="swiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <img src="<?php echo get_template_directory_uri() . '/img/emerald-pool-krabi-dome-tour-francophone.jpg'; ?>" alt="Tour guide francophone Emerald Pool Krabi" />
            <div class="cost">A partir de 49€ par personne</div>
            <div class="overlay">
              <h1>Emerald Pool</h1>
              <p>
